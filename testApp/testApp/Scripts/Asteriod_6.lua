...
a6RigidBody = PhysicsManager:CreateSphereRigidBody(0.10, 1.0, posX, posY, posZ, 0.0, 0.0, 0.0)
A6:SetRigidBody(a6RigidBody)
A6:updateObject(posX, posY, posZ)
--totation functions moves body away from model if used after update position
