...
Ro1:addModel(rock)
Ro1Rigid = PhysicsManager:CreateSphereRigidBody(0.10, 10.0, R1posX, R1posY, R1posZ, 0.0, 0.0, 0.0)
...
Ro2:addModel(rock)
Ro2Rigid = PhysicsManager:CreateSphereRigidBody(0.10, 10.0, R2posX, R2posY, R2posZ, 0.0, 0.0, 0.0)
...
Ro3:addModel(rock)
Ro3Rigid = PhysicsManager:CreateSphereRigidBody(0.10, 10.0, R3posX, R3posY, R3posZ, 0.0, 0.0, 0.0)
...
Ro4:addModel(rock)
Ro4Rigid = PhysicsManager:CreateSphereRigidBody(0.10, 10.0, R4posX, R4posY, R4posZ, 0.0, 0.0, 0.0)
...
Ro5:addModel(rock)
Ro5Rigid = PhysicsManager:CreateSphereRigidBody(0.10, 10.0, R5posX, R5posY, R5posZ, 0.0, 0.0, 0.0)
