...
void Menu::setUpMainMenu()
{
	...
	m_TextureMan = TextureManager::GetTextureManager();
	m_TextureMan.AddTexture("assets/images/menu.png");

	texture3 = m_TextureMan.GetTexture("assets/images/menu.png");
}

void Menu::setUpmanual()
{
...
void Menu::drawMainMenu(Shader S)
{
	S.Use();
	glUniform1i(glGetUniformLocation(S.Program, "texture3"), 0);
	glActiveTexture(GL_TEXTURE0);
